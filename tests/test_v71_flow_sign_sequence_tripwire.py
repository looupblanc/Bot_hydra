...
from hydra.validation.v71_flow_sign_sequence_tripwire import build_flow_sign_sequence_null_world
...
def test_flow_sign_sequence_tripwire_threshold_is_inclusive() -> None:
...
def test_flow_sign_null_preserves_sequence_and_changes_prices() -> None:
    minute, _, _ = load_event_time_sources(".")
    null = build_flow_sign_sequence_null_world(minute, control=D1NullControl.DAILY_BLOCK_SHUFFLE)
    for column in ("minute_start_ns", "availability_ns", "signed_aggressor_volume", "contract"):
