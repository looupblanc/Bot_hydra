...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run the frozen D1 grammar 0002 tripwire.")
    ...
    result = run_d1_grammar0002_tripwire(
    ...
    print(json.dumps({
        ...
        "pooled_null_pass_count": result["pooled_null"]["pass_count"],
