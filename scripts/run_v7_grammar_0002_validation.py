...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Run the WORM-frozen V7 grammar 0002 tribunal."
    )
    parser.add_argument("--project-root", default=".")
    parser.add_argument(
        "--preregistration",
        default="WORM/v7-grammar-0002-hypotheses-2026-07-12.json",
    )
    parser.add_argument(
        "--validation-policy",
        default="WORM/v7-grammar-0002-validation-policy-2026-07-12.json",
    )
    parser.add_argument(
        "--signal-manifest",
        default="reports/v7/phase4/grammar0002_signal_manifest.json",
    )
    parser.add_argument(
        "--tripwire-attestation",
        default="reports/v7/phase4/grammar0002_permanent_tripwire_attestation.json",
    )
    parser.add_argument(
    ...
    result = run_grammar_0002_validation(
