...
from hydra.validation.v7_grammar_0001_validation import run_grammar_validation


def main() -> int:
    parser = argparse.ArgumentParser(
        description="Run the WORM V7 grammar 0001 funnel and full-signal tripwire."
    )
    ...
    parser.add_argument(
        "--signal-manifest",
        default="reports/v7/phase4/grammar0001_signal_manifest.json",
    )
    parser.add_argument(
