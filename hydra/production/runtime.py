...
def read_live_status(manifest_path: str | Path) -> dict[str, Any]:
    ...
    if manifest.get("campaign_mode") == "AUTONOMOUS_ECONOMIC_DISCOVERY_DIRECTOR":
        ...
        return read_autonomous_director_status(manifest_path)
    ...
    if manifest.get("campaign_mode") == "HYBRID_STRUCTURAL_ALPHA_ORDER_FLOW":
        ...
        return read_microstructure_hybrid_status(manifest_path)
    if manifest.get("campaign_mode") == "MICROSTRUCTURE_SPARSE_ALPHA_DISTILLATION":
        ...
        return read_microstructure_sparse_status(manifest_path)
...
def run_production_manifest(
    ...
    *,
    ...
    if manifest.get("campaign_mode") == "AUTONOMOUS_ECONOMIC_DISCOVERY_DIRECTOR":
        ...
        return run_autonomous_director_manifest(
            manifest_path,
    ...
    if manifest.get("campaign_mode") == "HYBRID_STRUCTURAL_ALPHA_ORDER_FLOW":
        ...
        return run_microstructure_hybrid_manifest(
            manifest_path,
            contract_map_path=contract_map_path,
            cache_root=cache_root,
            stop_after=stop_after,
    ...
    if manifest.get("campaign_mode") == "MICROSTRUCTURE_SPARSE_ALPHA_DISTILLATION":
        ...
        return run_microstructure_sparse_manifest(
            manifest_path,
            contract_map_path=contract_map_path,
            cache_root=cache_root,
            stop_after=stop_after,
